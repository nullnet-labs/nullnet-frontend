        ...
        <header className={classes('border-b overflow-hidden relative', styles['lower-bordered-nav'])}>
            <div className="inline-block float-left">
                <nav className="flex flex-row-reverse justify-end">
                    <a href="/" className={classes('hover-invert', styles['nav-link'])}>
                        Tags
                    </a>
                    <a href="/posts" className={classes('hover-invert', styles['nav-link'])}>
                        Posts
                    </a>
                    <a href="/" className={classes('hover-invert', styles['nav-link'])}>
                        t[n.n]
            ...
            <div className="absolute bottom-px right-px h-full pr-6 text-md">
                <a href="/" className={classes('relative block px-6 hover-invert', styles['floating-link'])}>
